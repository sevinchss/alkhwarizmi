...
const AboutP = () => {
  return (
    <div className="text-gray-900 font-poppins">
      ...
      <section className="relative">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 py-12 gap-10">
          {/* Left Text */}
  ...
  "
          ...
          {/* Right Image */}
          <div className="bg-white md:w-1/2 relative">
            <img
              src={presidency}
              alt="Presidency"
        ...
        {/* Stats cards */}
        <div className="max-w-7xl mx-auto px-6 pb-20 py-10">
