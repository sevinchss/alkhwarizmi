...
const SchoolEventsPage = () => {
  ...
  const upcomingEvents = [
    ...
    { id: 2, name: 'Bristol Universiteti vakillari bilan uchrashuv', date: '17 Oktyabr 2025', description: 'Buyuk Britaniyaning yetakchi institutlaridan biri bo\'lgan Bristol universitetining akademik a\'zolari bilan tanishing! Universitet vakillari o\'quv va hayoti, qabul qilish va stipendiyalar haqida ma\'lumotlar bilan o\'rtoqlashadi.', image: event2 },
    { id: 3, name: 'El-yurt Fondi vakillari bilan uchrashuv', date: '17 Oktyabr 2025', description: 'Muhammad al-Xorazmiy nomidagi ixtisoslashtirilgan maktabiga 16-oktyabr kuni “El-yurt umidi” jamg‘armasi vakillari bilan uchrashuv tashkil qilindi. Uchrashuvga tashrif buyurganlar orasida “El-yurt umidi” jamgʻarmasi ijrochi direktori oʻrinbosari Shuhrat Daminov, Raqamlashtirish va axborot-tahlil boshqarmasi bosh inspektori Qahramon Bektemirov, O‘zbekiston Respublikasi Prezidenti huzuridagi Boshqaruv samaradorligi agentligining mas’ul xodimi O‘tkir Abdukarimovlar ham bor edi.', image: event3 },
    { id: 4, name: 'MAAB Innovation bilan uchrashuv', date: '26 Sentabr 2025', description: '9-11-sinf o\'quvchilari Muhammad al-Xorazmiy maktabida MAAB Innovation vakillari bilan ilhomlantiruvchi sessiyada qatnashdi. Kompaniya o\'quvchilarga 15 Oktyabrgacha Ma\'lumotlar fanlari testida ishtirok etish uchun maxsus imkoniyatni taqdim etdi.', image: event4 },
    { id: 5, name: 'Nazarbayev Universitetidan tashrif', date: '2 Oktyabr 2025', description: '10-oktabr kuni Muhammad al-Xorazmiy nomidagi ixtisoslashtirilgan maktabga Nazarbaev Universiteti vakillari tashrif buyurishdi.   Ushbu tashrif maktabimiz o‘quvchilari uchun yuqori ta’lim sohasidagi ilg‘or tajribalar bilan tanishish, kelajak rejalari va xalqaro dunyoqarashini kengaytirishda muhim ahamiyat kasb etadi.', image: event5 },
    { id: 6, name: 'Garvard bitiruvchisi bilan uchrashuv', date: '8 Oktyabr 2025', description: '8 Oktyabr kuni bizning maktabimizga Pollie Prep asoschisi va Sent-Pol maktabi va Garvard kolleji bitiruvchisi Dmitriy Soljenitsin xush kelib keldi. Dmitriy o\'z avlodining eng iste\'dodli o\'quvchilaridan biri va AQShning eng yaxshi universitetlariga qabul qilish bo\'yicha mutaxassis sifatida tanilgan.', image: event6 },
  ];

  const pastEvents = [
    { id: 7, name: '"Apple" kompaniyasidan mehmon', date: '10 Oktyabr 2025', description: '9-sentyabr kuni Muhammad al-Xorazmiy ixtisoslashtirilgan maktabiga dunyo miqyosida o‘z o‘rnini topgan, yosh bo‘lsa-da katta yutuqlarga erishgan Adilhan Kopabayev tashrif buyurdi! Adilhan Kopabayev — hozirda "Apple" kompaniyasining Markaziy Osiyo va Armaniston bo‘yicha rahbari. U o‘z yo‘lini oddiy talabalikdan boshlab, turli davlat idoralari va yirik tashkilotlarda ishlagan, shuningdek, Brown Universitetida talabalik davrini o‘tqizgan.', image: event7 },
