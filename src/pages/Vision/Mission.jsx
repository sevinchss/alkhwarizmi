    ...
    <div className="bg-gray-50 min-h-screen py-12 font-poppins scroll-smooth">
      <div className="max-w-7xl mx-auto px-6 md:px-15 flex flex-col md:flex-row gap-8">
        ...
        <main className="bg-white rounded-2xl shadow-sm p-8 flex-1">
          ...
          {/* HISTORY SECTION */}
          <section id="history" ref={historyRef} className="mt-20">
            ...
            <div className="relative pl-12">
              <div className="absolute left-[57px] top-0 w-[3px] h-full bg-gray-400"></div>
              {timeline.map((item, index) => {
                const isLatest = index === timeline.length - 1;
                return (
                  <div key={index} className="relative mb-12 flex items-start">
                    <div
                      className={`absolute left-0 top-1.5 w-5 h-5 rounded-full border-4 border-white shadow-md ${
                        isLatest
                    ...
                    <div className="ml-10">
                      <h3
                        className={`${
                          isLatest
                            ? "text-blue-900 text-xl font-bold"
