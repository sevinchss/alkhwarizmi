...
import bg1 from "./images/graf2.jpg";
import bg2 from "./images/mobil.jpg";
import bg3 from "./images/webb.jpg";
import bg4 from "./images/tarm.jpg";
  ...
  return (
    <section className="py-20 bg-[#eef3ff] font-poppins overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div data-aos="zoom-in" data-aos-delay="100" className="grid grid-cols-1 lg:grid-cols-2 gap-12">
