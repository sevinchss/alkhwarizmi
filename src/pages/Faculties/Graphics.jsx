...
import { PenTool, Paintbrush, Layers, Camera, Monitor, Palette } from "lucide-react";
...
export const GraphicsPage = () => {
  const technologies = [
    { name: "Adobe Photoshop", icon: <Paintbrush className="w-8 h-8 text-sky-400" /> },
    { name: "Adobe Illustrator", icon: <PenTool className="w-8 h-8 text-sky-400" /> },
    { name: "CorelDRAW", icon: <Palette className="w-8 h-8 text-sky-400" /> },
    { name: "Blender 3D", icon: <Layers className="w-8 h-8 text-sky-400" /> },
    { name: "Figma / UI Design", icon: <Monitor className="w-8 h-8 text-sky-400" /> },
    { name: "Adobe After Effects", icon: <Camera className="w-8 h-8 text-sky-400" /> },
  ];
  ...
  return (
    <section className="relative min-h-screen font-poppins bg-gradient-to-b from-[#001635] via-[#002b80] to-[#003fa8] text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-16">
        <h2 className="text-3xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-blue-100 to-blue-300 ">
