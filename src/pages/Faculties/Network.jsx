...
import { Server, Wifi, Shield, Cloud, Cpu, Database } from "lucide-react";
...
export const NetworkPage = () => {
  const technologies = [
    { name: "Cisco Networking", icon: <Server className="w-8 h-8 text-sky-400" /> },
    { name: "MikroTik RouterOS", icon: <Wifi className="w-8 h-8 text-sky-400" /> },
    { name: "Network Security", icon: <Shield className="w-8 h-8 text-sky-400" /> },
    { name: "Cloud Infrastructure", icon: <Cloud className="w-8 h-8 text-sky-400" /> },
    { name: "Server Administration", icon: <Cpu className="w-8 h-8 text-sky-400" /> },
    { name: "Database Systems", icon: <Database className="w-8 h-8 text-sky-400" /> },
  ];
