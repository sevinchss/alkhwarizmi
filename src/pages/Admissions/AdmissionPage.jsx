        ...
        <main className="bg-white rounded-2xl shadow-sm p-8 flex-1">
          ...
          <section id="application" ref={applicationRef}>
            ...
            <h1 className="text-2xl font-semibold text-black mb-6">
              ...
              MUHAMMAD Al-XORAZMIY NOMIDAGI IXTISOSLASHTIRILGAN MAKTABGA QANDAY KIRISH MUMKIN
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <ul className="list-disc ml-5 text-gray-700 space-y-2">
                  ...
                  <li>Nomzodning online ariza topshirgandan so'ng berilgan imtixon uchun ma'lumotnomasi</li>
          ...
          <section id="grades" ref={gradesRef}>
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                hisobga olinadigan muhim omillardan biridir.
